...
<div class="tab-content">
    <div class="tab-pane fade active in" id="c-info">
        ...
        <p class="comment">
            ...
            <p class="comment">
                <p>Uppercase the first letter of the string</p>
  ...
  formats to: Car</p>
            ...
            <table class="table table-sm table-hover">
                <tbody>
                    <tr>
                        ...
                        <td class="col-md-9">firstUpper</td>
                    </tr>
                </tbody>
            </table>
        </section>
    ...
    <table class="table table-sm table-bordered">
        <tbody>
            ...
            <tr>
                <td class="col-md-4">
<code>transform(value, args)</code>
                </td>
            </tr>
            ...
            <tr>
                <td class="col-md-4">
                    <div class="io-line">Defined in <a href="" data-line="87"
                            class="link-to-prism">src/typings.ts:87</a></div>
                </td>
            </tr>
...
namespace BSBO {
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'FirstUpperPipe2.html';
