...
<div class="container-fluid modules">
    <div class="row">
            ...
            <div class="col-sm-4">
                <div class="card card-module">
                    <div class="card-header">
                        <h4 class="card-title">AboutModule2</h4>
                    </div>
                    <div class="card-block">
                                <p class="no-graph">
                                    No graph available.
                        ...
                        <footer class="text-center">
                            <a href="./modules/AboutModule2.html" class="btn btn-default">Browse</a>
                        </footer>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card card-module">
                    ...
                    <div class="card-block">
                                <p>
                                    <object id="demo-svg" type="image/svg+xml" lazy="./modules/AboutRoutingModule/dependencies.svg" style="width: 100%; height: 175px;">
                                        Your browser does not support SVG
                                    </object>
                                </p>
                        <footer class="text-center">
