...
<div class="tab-content">
        <div class="tab-pane fade active in" id="c-info">
            ...
            <p class="comment">
                <code>src/app/shared/auth-guard.ts</code>
            </p>
                ...
                <p class="comment">
                                <code><a href="https://angular.io/api/router/CanActivate" target="_blank" >CanActivate</a></code>
                </p>
    ...
    <table class="table table-sm table-bordered">
            ...
            <tr>
                <td class="col-md-4">
                    <div class="io-line">Defined in <a href="" data-line="4"
                            class="link-to-prism">src/app/shared/auth-guard.ts:4</a></div>
                </td>
            </tr>
        ...
        <div class="tab-pane fade  tab-source-code" id="c-source">
            <pre class="line-numbers compodoc-sourcecode"><code class="language-typescript">import { CanActivate } from &#x27;@angular/router&#x27;;
...
class AuthGuard implements CanActivate {
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'AuthGuard.html';
